...
export const alt = 'Terms of Service - RelayPost';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10, maxWidth: '85%', marginTop: 'auto', marginBottom: 'auto' }}>
          <h1 style={{ fontSize: 84, fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }}>Terms of Service</h1>
          <p style={{ fontSize: 40, color: '#bcc7de', marginTop: 32, lineHeight: 1.4 }}>
            Read our Terms of Service to understand the guidelines, rules, and agreements for using the RelayPost platform and its content.
          </p>
        </div>
