...
export default function InteractiveData() {
  ...
  return (
    <section>
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-dark-bg mb-1 border-l-4 border-[#4f46e5] pl-3">Interactive Data</h2>
      ...
      <div className="overflow-hidden w-full relative pb-4">
        <div className="animate-marquee gap-0">
          {charts.map((chart, i) => (
            <div key={i} className="w-[300px] shrink-0 bg-white p-5 border border-gray-200 overflow-hidden flex flex-col group cursor-pointer hover:bg-gray-50 hover:-translate-y-2 active:-translate-y-3 hover:shadow-xl hover:z-10 transition-all duration-300">
              ...
              <div className="h-16 mt-4 flex items-end justify-between gap-1 px-1">
