...
export default function ContributePage() {
  ...
  return (
    <div className="bg-[#0A0D1F] min-h-screen text-white font-sans selection:bg-brand">
      <Navbar />
             ...
             {success ? (
                ...
                >
                   ...
                   <div className="space-y-4">
                      ...
                      <p className="text-emerald-200/60 max-w-sm mx-auto font-medium">Your contribution has been moved to the <span className="text-white font-bold">Inquiry Queue</span>. Administrators will review the dispatch for editorial alignment.</p>
                   </div>
                   <button 
                   ...
                   <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
                         ...
                         <div className="flex flex-wrap gap-4">
                            {['dispatch', 'deep-dive', 'breaking', 'editorial'].map(t => (
                               <button 
                                 ...
                                 className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border transition-all ${formData.content_type === t ? 'bg-brand border-brand text-white shadow-lg shadow-brand/20' : 'bg-white/5 border-white/10 text-slate-400 hover:border-white/20'}`}
                               >
                                  {t}
                               </button>
                            ))}
                      ...
                      <div className="space-y-4">
                        ...
                        <input 
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-5 focus:ring-2 focus:ring-brand/40 outline-none transition-all font-bold placeholder:text-slate-600"
                        />
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <textarea 
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-[2rem] px-6 py-6 focus:ring-2 focus:ring-brand/40 outline-none transition-all font-medium placeholder:text-slate-600 min-h-[250px] leading-relaxed"
                        />
                      </div>
