        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center mb-10" style={{ transform: "translateZ(60px)" }}>
              ...
              >
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 text-3xl font-black tracking-tighter uppercase">Editorial</span>
              </motion.div>
              ...
              <div className="pt-4">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-[10px]">
                    <span className="px-3 bg-transparent text-slate-600 font-bold uppercase tracking-[0.2em]">Universal Link</span>
                  </div>
                </div>
          ...
          >
            <span className="text-[10px] text-white/10 tracking-[0.8em] font-mono uppercase">Neural Operator: Relay-01B</span>
          </motion.div>
        </motion.main>
      </div>
    </GoogleOAuthProvider>
