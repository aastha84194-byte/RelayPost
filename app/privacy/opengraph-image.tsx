...
export const alt = 'Privacy Policy - RelayPost';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10, maxWidth: '85%', marginTop: 'auto', marginBottom: 'auto' }}>
          <h1 style={{ fontSize: 84, fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }}>Privacy Policy</h1>
          <p style={{ fontSize: 40, color: '#bcc7de', marginTop: 32, lineHeight: 1.4 }}>
            We believe in transparency and data protection. Learn exactly how RelayPost safeguards your personal information and respects your privacy.
          </p>
        </div>
