...
export const alt = 'Contact RelayPost';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10, maxWidth: '85%', marginTop: 'auto', marginBottom: 'auto' }}>
          <h1 style={{ fontSize: 84, fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }}>Contact Us</h1>
          <p style={{ fontSize: 40, color: '#bcc7de', marginTop: 32, lineHeight: 1.4 }}>
            Need assistance or have a story to share? Reach out to the RelayPost team for support, partnerships, or editorial inquiries.
          </p>
        </div>
