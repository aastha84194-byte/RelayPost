...
export const alt = 'News Categories - RelayPost';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10, maxWidth: '85%', marginTop: 'auto', marginBottom: 'auto' }}>
          <h1 style={{ fontSize: 84, fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }}>Explore Categories</h1>
          <p style={{ fontSize: 40, color: '#bcc7de', marginTop: 32, lineHeight: 1.4 }}>
            Browse through our extensive list of curated categories. Discover deeply analyzed news and insightful articles tailored to your interests.
          </p>
        </div>
